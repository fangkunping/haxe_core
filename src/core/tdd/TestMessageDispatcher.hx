...
class TestMessageDispatcher {
	...
	static public function is_telegram_in_message_dispatcher(message_dispatcher:MessageDispatcher, _event_name:String):Bool {
		return message_dispatcher.telegrams.exists(_event_name) && message_dispatcher.telegrams[_event_name].length == 1;
	}

	static public function is_event_in_message_dispatcher(message_dispatcher:MessageDispatcher, _event_name:String, uuid:Int):Bool {
